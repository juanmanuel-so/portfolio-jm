...
const hypermantis = async ({params}:{params:Promise<{lang:string}>}) => {
  ...
  return (
    <main className="dark:bg-juan-black bg-juan-light dark:text-juan-light text-juan-black w-screen h-dvh pt-25">
